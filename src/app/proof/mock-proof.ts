export default [
  ...
  {
    name: 'Certificat du cours - Web tech.png',
    description: 'Un certificat du cours en ligne de technologie Web sur le site "MOOC".',
    tags: ['html', 'css', 'javascript'],
    path: 'assets/files/Certificat du cours - Web tech.png'
  },
  {
  ...
  {
    name: 'Compte rendu - 12 jan 2018.doc',
